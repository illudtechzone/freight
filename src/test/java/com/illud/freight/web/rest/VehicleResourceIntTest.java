...
public class VehicleResourceIntTest {
    ...
    private static final Long DEFAULT_VEHICLE_LOOKUP_ID = 1L;
    private static final Long UPDATED_VEHICLE_LOOKUP_ID = 2L;
     ...
     *
     * @see com.illud.freight.repository.search.VehicleSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Vehicle createEntity(EntityManager em) {
        Vehicle vehicle = new Vehicle()
            ...
            .vehicleLookupId(DEFAULT_VEHICLE_LOOKUP_ID)
    ...
    public void createVehicle() throws Exception {
        ...
        assertThat(testVehicle.getVehicleLookupId()).isEqualTo(DEFAULT_VEHICLE_LOOKUP_ID);
    ...
    public void getAllVehicles() throws Exception {
        ...
        restVehicleMockMvc.perform(get("/api/vehicles?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].vehicleLookupId").value(hasItem(DEFAULT_VEHICLE_LOOKUP_ID.intValue())))
    ...
    public void getVehicle() throws Exception {
        ...
        restVehicleMockMvc.perform(get("/api/vehicles/{id}", vehicle.getId()))
            ...
            .andExpect(jsonPath("$.vehicleLookupId").value(DEFAULT_VEHICLE_LOOKUP_ID.intValue()))
    ...
    public void updateVehicle() throws Exception {
        ...
        updatedVehicle
            ...
            .vehicleLookupId(UPDATED_VEHICLE_LOOKUP_ID)
        ...
        assertThat(testVehicle.getVehicleLookupId()).isEqualTo(UPDATED_VEHICLE_LOOKUP_ID);
