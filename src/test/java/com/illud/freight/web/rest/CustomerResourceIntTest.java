...
public class CustomerResourceIntTest {
    ...
    private static final String DEFAULT_CUSTOMER_IDP_CODE = "AAAAAAAAAA";
    private static final String UPDATED_CUSTOMER_IDP_CODE = "BBBBBBBBBB";
     ...
     *
     * @see com.illud.freight.repository.search.CustomerSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            .customerIdpCode(DEFAULT_CUSTOMER_IDP_CODE)
            .name(DEFAULT_NAME)
            .email(DEFAULT_EMAIL)
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCustomerIdpCode()).isEqualTo(DEFAULT_CUSTOMER_IDP_CODE);
    ...
    public void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].customerIdpCode").value(hasItem(DEFAULT_CUSTOMER_IDP_CODE.toString())))
    ...
    public void getCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/customers/{id}", customer.getId()))
            ...
            .andExpect(jsonPath("$.customerIdpCode").value(DEFAULT_CUSTOMER_IDP_CODE.toString()))
    ...
    public void updateCustomer() throws Exception {
        ...
        updatedCustomer
            .customerIdpCode(UPDATED_CUSTOMER_IDP_CODE)
            .name(UPDATED_NAME)
            .email(UPDATED_EMAIL)
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getCustomerIdpCode()).isEqualTo(UPDATED_CUSTOMER_IDP_CODE);
    ...
    public void searchCustomer() throws Exception {
        ...
        restCustomerMockMvc.perform(get("/api/_search/customers?query=id:" + customer.getId()))
            ...
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(customer.getId().intValue())))
            .andExpect(jsonPath("$.[*].customerIdpCode").value(hasItem(DEFAULT_CUSTOMER_IDP_CODE)))
